	...
	<div class="regist">
		<div class="regist_center">
			...
			<div class="center-block" style="margin-top: 80px;">
				<form class="form-horizontal" action="/users?method=register" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-8" style="width: 40%">
							<input type="password" name="repeatpassword"  class="form-control col-sm-10"
					...
					<div class="form-group">
						...
						<div class="col-sm-8" style="width: 40%">
							<input type="text" name="nickname" class="form-control col-sm-10"
								   placeholder="nickname" />
						</div>
						<div class="col-sm-2">
							<p class="text-danger"><span id="helpBlock" class="help-block ">请填写昵称</span></p>
						</div>
					</div>
					<div class="form-group">
